...
export interface ApiDayMenuDayMenu extends Struct.CollectionTypeSchema {
  collectionName: 'day_menus';
  info: {
    description: 'Denn\u00E9 menu';
    displayName: 'Day Menu';
    pluralName: 'day-menus';
    singularName: 'day-menu';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    cook: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInventoryItemInventoryItem
  ...
  info: {
    description: 'Polo\u017Eka v z\u00E1sob\u00E1ch';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    lowStock: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiMealMeal extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Jedlo v jed\u00E1lni\u010Dku';
    displayName: 'Meal';
    pluralName: 'meals';
    singularName: 'meal';
  };
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['rychle', 'vikendove', 'specialne']
    > &
      Schema.Attribute.DefaultTo<'rychle'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiShoppingItemShoppingItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'shopping_items';
  info: {
    description: 'Polo\u017Eka n\u00E1kupn\u00E9ho zoznamu';
    displayName: 'Shopping Item';
    pluralName: 'shopping-items';
    singularName: 'shopping-item';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shopping-item.shopping-item'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiSpecialEventSpecialEvent
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date & Schema.Attribute.Required;
    eventMeals: Schema.Attribute.Component<'event.event-meal', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    shoppingList: Schema.Attribute.Component<'event.shopping-item', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::day-menu.day-menu': ApiDayMenuDayMenu;
      ...
      'api::shopping-item.shopping-item': ApiShoppingItemShoppingItem;
